...
- **method**: Optional. A character string specifying the method to calculate bin width. Options are "wang" (default) or "sturges". wang refers to the formula by Wang et al. (2020).
...
freqTable <- FrequencyTable(data = lenght_data, method = "wang", Lmax = 75)
